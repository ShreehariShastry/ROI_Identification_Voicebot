...
class NeuralNetwork:
    ...
    def train(self, input_vector, target_vector):
        ...
        self.weights_hidden_out = self.weights_hidden_out + tmp
        ...
        self.weights_in_hidden = self.weights_in_hidden + (self.learning_rate * x)
...
def train_nn(data, labels, test_data):
