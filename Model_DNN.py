...
def DNN_GET_WEIGHT(data, labels, test_data, sol=8):
    simple_network = NeuralNetwork(no_of_in_nodes=data.shape[1],
                                   no_of_out_nodes=1,
                                   no_of_hidden_nodes=sol,
                                   learning_rate=0.1,
                                   bias=None)
    ...
    weight = simple_network.weights_hidden_out
    return weight


def Model_DNN(data, labels, test_data, test_target):
    simple_network = NeuralNetwork(no_of_in_nodes=data.shape[1],
